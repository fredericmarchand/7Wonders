...
public class TheLighthouseOfAlexandria extends WonderBoard {
	...
	{
		super(2, side);
		stage1 = new WonderBoardStage((Side == 1 ? new Resources(0, 2, 0, 0, 0, 0, 0, 0) : new Resources(0, 0, 0, 2, 0, 0, 0, 0)));
		stage2 = new WonderBoardStage((Side == 1 ? new Resources(2, 0, 0, 0, 0, 0, 0, 0) : new Resources(0, 0, 2, 0, 0, 0, 0, 0)));
		stage3 = new WonderBoardStage((Side == 1 ? new Resources(0, 0, 0, 0, 2, 0, 0, 0) : new Resources(0, 3, 0, 0, 0, 0, 0, 0)));
	}
