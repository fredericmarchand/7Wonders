...
public class ThePyramidsOfGiza extends WonderBoard {
	...
	{
		super(7, side);
		stage1 = new WonderBoardStage((Side == 1 ? new Resources(0, 2, 0, 0, 0, 0, 0, 0) : new Resources(0, 0, 2, 0, 0, 0, 0, 0)));
		stage2 = new WonderBoardStage((Side == 1 ? new Resources(0, 0, 3, 0, 0, 0, 0, 0) : new Resources(0, 3, 0, 0, 0, 0, 0, 0)));
		stage3 = new WonderBoardStage((Side == 1 ? new Resources(0, 4, 0, 0, 0, 0, 0, 0) : new Resources(0, 0, 0, 3, 0, 0, 0, 0)));
		if ( Side == 2 )
	...
	{
		if ( (Side == 2) && stage1.isBuilt() && stage2.isBuilt() && stage3.isBuilt() && !stage4.isBuilt() )
